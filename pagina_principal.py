...
def home():
    ...
    with col1:
        ...
        st.markdown("<div class='left-column'><a class='button-container' href='http://localhost:8501/loveit'><button class='custom_button leftbutton'>Love It</button></div></div>", unsafe_allow_html=True)

    with col2:
        st.markdown(righ_col_style, unsafe_allow_html=True)
        st.markdown("<div class='right-column'><a class='button-container' href='http://localhost:8501/listit'><button class='custom_button rightbutton' target='_blank'>List It</button></div></div>", unsafe_allow_html=True)
